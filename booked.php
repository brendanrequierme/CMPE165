...
<?php
    ...
    while ($row = mysqli_fetch_array($stmt)) {
        ...
        <table>
        <div>
        <form action = 'delete.php?hotelID=$hotelID&hotelPRICE=$hotelPrice&roomNUMBER=$roomNumber&bookedID=$bookedID&startDATE=$strtDate&endDATE=$enDate' method='POST' name='RemoveHotel'>
        ...
        <td>
            ...
            <input type='date' name='$strtDate' value = 'startDATE' style = margin-left:215px;/>
        </td>
        <td>
            <p style = margin-left:50px; for='start'>Choose End Date: </p>
            <input type='date' name='$enDate' style = margin-left:50px;/>
        </td>
        </tr>
