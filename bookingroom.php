...
<?php
        ...
        while ($row = mysqli_fetch_array($stmt)) {
            ...
            <div>
            <table style = margin-left:300px>
                <td><img style = margin-right:15px class = 'picBorder' src = 'images/basic room.jpg' width='120' height='120'/></td>
                <td>
            ...
            echo"
            <div style = margin-left:265px; id = 'restaurantAlign'>
            <table style = text-align:center style = margin-left:500px>
                <td style = margin-right:250px>
