...
<body>
    ...
    <table style margin = "400px" class = "top">
        <tr>
            ...
            <td><a class = redTextRPad2 href = "http://localhost/CMPE165/login.php">Sign In</a></td>
    ...
    <table align = "center">
        ...
        <tr>
            <td>We have over 50 million happy members and have given away over 25 million reward nights around the world. Here's what our members have to say</td>
        </tr>
    </table>
